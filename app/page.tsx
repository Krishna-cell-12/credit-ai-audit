...
export default function Home() {
  ...
  function addTool() {
    ...
    setAuditData((prev) => ({ ...prev, tools: [...prev.tools, newTool] }));
  }
  ...
  function handleSubmit(e: React.FormEvent) {
    e.preventDefault();
    console.log("[AI Spend Auditor] Submitted state:", auditData);
  }
          ...
          <form onSubmit={handleSubmit} noValidate className="space-y-8">
            ...
            <div className="flex flex-col items-center gap-3">
              <button
                id="run-audit-btn"
                type="submit"
                className="group relative w-full overflow-hidden rounded-2xl bg-gradient-to-r from-indigo-600 to-violet-600 px-8 py-4 text-base font-semibold text-white shadow-lg shadow-indigo-900/40 transition hover:shadow-indigo-700/50 hover:brightness-110 active:scale-[0.98] sm:w-auto sm:min-w-[260px]"
              >
